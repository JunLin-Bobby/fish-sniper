...
def get_google_oauth_token_exchange_callable() -> Callable[..., dict]:
    ...
    from app.auth.google_oauth import exchange_authorization_code_for_token_response
...
def get_google_jwks_key_resolver():
    ...
    from app.auth.google_id_token import build_default_google_jwks_key_resolver
